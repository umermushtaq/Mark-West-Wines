                ...
                <div id="login-form">
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                                ...
                                <?php
                               echo $content = '<a href="https://www.facebook.com/dialog/oauth?client_id='.$config['App_ID'].'&redirect_uri='.$config['callback_url'].'&scope=email&display=popup"><img src="../../../images/Facebook.png" class="fb-button"/></a>';
                             ?>     
